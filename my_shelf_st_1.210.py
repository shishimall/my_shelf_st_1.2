# my_shelf_st
# 📦 JANCodeLookup + Google Sheets連携 + OpenAI OCR（gpt-4o-mini対応・完全安定版）

import streamlit as st
st.set_page_config(page_title="my_shelf v1.210", layout="wide")
st.title("📦 my_shelf v1.210（Cloud安定動作＋全機能版）")
...
st.caption("© 2025 my_shelf v1.210 — Cloud安定対応版（use_column_width＋proxies回避＋全処理）")
