...
# ☁️ Streamlit Cloud 完全対応版（proxies問題解消＋全機能保持）

import streamlit as st
st.set_page_config(page_title="my_shelf v1.211", layout="wide")
st.title("📦 my_shelf v1.211（Cloud安定動作＋HTTP直呼び出し版）")
...
st.caption("© 2025 my_shelf v1.211 — Cloud完全対応版（HTTP直呼び出しOCR＋全機能保持）")
