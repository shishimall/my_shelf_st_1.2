...
st.set_page_config(page_title="my_shelf v1.204", layout="wide")
st.title("📦 my_shelf v1.204（JANCodeLookup + GS + Secrets/.env対応）")
...
# ✅ Cloud 安全化: None や空ファイルでもエラーにならないよう保護
...
st.caption("© 2025 my_shelf v1.204 — Cloud安全版（画像安全処理＋1.201メイン完全踏襲）")
