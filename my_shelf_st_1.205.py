# my_shelf_st
# 📦 JANCodeLookup + Google Sheets 連携 + OpenAI OCR（gpt-4o-mini）
# ☁️ Streamlit Cloud 安定版（openai>=1.x完全対応）
# 🧲 1.201 メイン処理を踏襲＋画像安全化＋Cloud認証強化

import streamlit as st
st.set_page_config(page_title="my_shelf v1.205", layout="wide")
st.title("📦 my_shelf v1.205（JANCodeLookup + GS + OCR安定対応）")
...
# ------------------------------------------------------------
# 🔐 Google Sheets 認証（Secrets > JSONファイル）
# ------------------------------------------------------------
...
st.caption("© 2025 my_shelf v1.205 — 完全Cloud対応（openai>=1.x準拠）")
